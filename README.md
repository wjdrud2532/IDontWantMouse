...
| `macos-keyboard/karabiner.json` | Karabiner-Elements 설정. 넘패드로 마우스 제어 + `₩`(grave = 숫자 1 왼쪽) 레이어(방향키 / +Space 단어·단락 이동) + `Opt` 레이어(마우스 포인터 / +₩ 클릭·스크롤). 한영 전환은 Karabiner 밖(Fn 지구본 키) | macOS `~/.config/karabiner/karabiner.json` |
